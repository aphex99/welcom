...
const SkeletonTable = ({
    ...
    return (
        <div
            ...
            className={"max-w-(--skeleton-width) mt-20 px-10 xl:px-0 m-auto"}
        >
            <div
                className={"mb-2 bg-zinc-300 h-8 animate-pulse rounded-sm"}
            ></div>
            <div
            ...
            >
                {Array.from({ length: count }, (_, i) => (
                    <div
                        ...
                        className={
                            "bg-zinc-200 w-full h-(--skeleton-lheight) animate-pulse rounded-sm"
                        }
                    ></div>
                ))}
                <div
